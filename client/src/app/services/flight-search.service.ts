...
export class FlightSearchService {
  ...
  postOffers(options: {offerRequest?: OfferRequest, prq?: String}): Promise<PartialOffer>{
    ...
    return firstValueFrom<PartialOffer>(
      this.http.post<PartialOffer>('http://bewildered-stitch-production.up.railway.app/api/v1/search/offers', data, { headers })
    )
    .then(results => {
  ...
  getFullFare(data: any): Promise<PartialOffer> {
    ...
    return firstValueFrom<PartialOffer>(
      this.http.get<PartialOffer>('http://bewildered-stitch-production.up.railway.app/api/v1/search/fullFare', { params })
    )
    .then(results => {
  ...
  postOrderCreate(data: any, token: any): Promise<any> {
    ...
    return firstValueFrom<any>(
      this.http.post<any>('http://bewildered-stitch-production.up.railway.app/api/v1/order/create', data, { headers })
    )
    .then(results => {
  ...
  getAirports(data: any): Promise<any> {
    ...
    return firstValueFrom<any>(
      this.http.get<any>('http://bewildered-stitch-production.up.railway.app/api/v1/search/airports', { params, headers })
    )
  }
  ...
  getAllOrdersByUserId(token: any): Promise<any> {
    const headers = new HttpHeaders()
        ...
        .set('Authorization', `Bearer ${token}`);
    return firstValueFrom<any>(
      this.http.get<any>('http://bewildered-stitch-production.up.railway.app/api/v1/order/getAllByUserId', { headers })
    )
  }
  ...
  getOrderByBookingRef(data: any): Promise<any> {
    ...
    return firstValueFrom<any>(
      this.http.get<any>('http://bewildered-stitch-production.up.railway.app/api/v1/order/getByBookingRef', { params, headers })
    )
  }
  ...
  deleteOrder(data: any, token: any): Promise<any> {
    ...
    return firstValueFrom<any>(
      this.http.delete<any>('http://bewildered-stitch-production.up.railway.app/api/v1/order/delete', { params, headers })
    )
  } 
